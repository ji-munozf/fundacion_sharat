    ...
    <div class="bg-white shadow rounded-lg p-6 dark:bg-gray-800">
        ...
        <form action="{{ route('portal.postulations.update', $postulation) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                class="block p-2.5 w-full text-gray-900 bg-gray-50 rounded-lg border focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ old('reasons', $postulation->reasons) }}</textarea>
            </div>
