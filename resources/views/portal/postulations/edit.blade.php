...
<x-portal-layout :breadcrumb="[
    ...
    <div class="bg-white shadow rounded-lg p-6 dark:bg-gray-800">
        <div class="mb-4 text-center text-lg dark:text-white">
            Postular a vacante: {{ $postulation->vacancy->name }}
        </div>

        <div class="mb-4 text-start text-sm">
            Descripción: <br> {{ $postulation->vacancy->description }}.
        </div>

        <form action="{{ route('portal.postulations.update', $postulation) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <x-input name="email" type="email" class="w-full bg-gray-50"
                    value="{{ old('email', $postulation->email) }}" />
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="message" name="reasons" rows="4"
                    class="block p-2.5 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ old('reasons', $postulation->reasons) }}</textarea>
            </div>
