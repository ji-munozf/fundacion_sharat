...
<x-portal-layout :breadcrumb="[
    ...
    <div class="bg-white shadow rounded-lg p-6 dark:bg-gray-800">
        ...
        <form action="{{ route('portal.postulations.sendRequestVacancy', $vacancy) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                <div class="grid items-end gap-6 md:grid-cols-2">
                    <div class="relative">
                        ...
                        <x-input name="names" type="text" class="w-full bg-gray-50" value="{{ old('names') }}" />
                    </div>
                    <div class="relative">
            ...
            <div class="mb-4">
                ...
                <x-input name="contact_number" type="text" class="w-full bg-gray-50" placeholder="+569XXXXXXXX"
                    value="{{ old('contact_number') }}" oninput="this.value = this.value.replace(/[^0-9+]/g, '');" />
            ...
            <div class="mb-4">
                ...
                <span class="text-xs text-gray-600 dark:text-gray-400">Recuerde que son máximo 10 fortalezas y que debe separar con comas.</span>
            </div>

            <div class="mb-4">
                <x-label class="mb-2">¿Por qué quieres aplicar al puesto?</x-label>
                <textarea id="message" name="reasons" rows="4"
                    class="block p-2.5 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ old('reasons') }}</textarea>
            </div>
