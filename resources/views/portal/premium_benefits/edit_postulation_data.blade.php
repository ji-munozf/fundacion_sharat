@section('title', 'Sharat - Editar datos de postulación')
...
<x-portal-layout :breadcrumb="[
    ...
    [
        'name' => 'Editar datos de postulación',
    ],
]">
        ...
        <form action="{{ route('portal.premium_benefits.updatePostulationData', $postulationUserData) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <x-input name="email" type="email" class="w-full bg-gray-50"
                    value="{{ old('email', $postulationUserData->email) }}" />
            </div>
