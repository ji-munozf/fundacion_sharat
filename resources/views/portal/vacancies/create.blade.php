        ...
        <form action="{{ route('portal.vacancies.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4"
                    ...
                    placeholder="Ingrese la descripción del puesto">{{ old('description') }}</textarea>
            </div>

            <div class="mb-4">
                <x-label class="mb-2">Gerente de contrataciones</x-label>
                <x-input name="contracting_manager" type="text" class="w-full"
                    placeholder="Ingrese el gerente de contrataciones" value="{{ old('contracting_manager') }}" />
            </div>
            ...
            @if (Auth::check() && Auth::user()->hasRole(['Super admin', 'Admin']))
                <div class="mb-4">
                    <x-label class="mb-2">Institución</x-label>
